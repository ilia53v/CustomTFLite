...
class VideoGLTextureView @JvmOverloads constructor(
    ...
    */
/** Устанавливаем callback, вызываемый при готовности нового кадра **//*
    ...
    */
/** Отмечаем, что текущий кадр обработан и можно захватывать следующий **//*
    ...
    */
/** Захват текущего кадра в Bitmap **//*
...
/** Инициализация MediaPlayer **//*
    ...
    override fun onSurfaceTextureUpdated(surface: SurfaceTexture) {
        // Обработка каждого нового кадра
