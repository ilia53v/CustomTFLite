...
fun VideoWithInference(
    ...
    yolo: YoloV8SegmentorV2,
    confidenceThreshold: Float,
    overlayBitmapRef: MutableState<OverlayFrame?>,
    speed: Float,
    isPlayingState: MutableState<Boolean>? = null // для синхронизации кнопки Play/Pause
) {
        ...
        FrameLayout(context).apply {
            ...
            videoView.setOnFrameRequested {
                ...
                scope.launch(Dispatchers.Default) {
                    ...
                    // --- Авто-пауза при обнаружении объектов ---
                    if (objects.isNotEmpty()) {
                        Log.d("VideoWithInference", "Object detected! Pausing video")
                        videoView.pause()
    ...
    // --- Рендеринг оверлея поверх видео ---
